# Gewerbeanmeldung Importgewerbe ZEDAR — Ablauf

Stand 22.09.2026. Ziel: anmeldefähig sein, bevor am 06.10.2026 über die Produktion entschieden wird.

## 1. Gewerbeanmeldung (Gewerbeamt Leipzig, Formular GewA 1)
...
- Fragebogen zur steuerlichen Erfassung über ELSTER. Die Anmeldung wird vom Gewerbeamt weitergeleitet, der Fragebogen muss trotzdem selbst ausgefüllt werden.
- **Kleinunternehmerregelung § 19 UStG hier nicht wählen.** Beim Import fällt Einfuhrumsatzsteuer an, die nur als Regelbesteuerter als Vorsteuer abgezogen werden kann. Bei einer Erstcharge in dieser Größenordnung ist der Unterschied sofort spürbar.
- Im selben Zug die USt-IdNr. beantragen.

## 3. EORI-Nummer
- Antrag über das Zoll-Portal beim Stammdatenmanagement der Generalzolldirektion, Dienstort Dresden. Ohne EORI keine Zollanmeldung, also keine Einfuhr.
- Bearbeitung dauert; direkt nach der Gewerbeanmeldung stellen.

## 4. Geschäftskonto
- Erst nach Gewerbeanmeldung möglich, Gewerbeanmeldung als Nachweis. Für die USD-Zahlungen an FTS auf Fremdwährungsüberweisungen und Wechselkursaufschlag achten — das ist bei den Hausbanken der teuerste Posten.

## 5. IHK Leipzig
- Pflichtmitgliedschaft entsteht automatisch mit der Gewerbeanmeldung. Nutze das: Die Beratung zu Zolltarifnummern, Ursprungsnachweisen und Einfuhrabgaben ist im Beitrag enthalten.
