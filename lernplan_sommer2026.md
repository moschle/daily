# Lernplan & Tagesstruktur Sommer 2026
...
- GLOSS Persian (gloss.dliflc.edu) — ergänzend, Lesen + Hören
- Morgenbrief (ungerade Tage)

### Arabisch (Shami + MSA)
- GLOSS Levantine Arabic (gloss.dliflc.edu) — kostenlos, authentische Materialien mit Transkript, 20–30 Min./Tag
...
- Sonst alles kostenlos/vorhanden

---

## 2. Tagesablauf

Erst Bewegung + GLOSS/Glossika. Wenn das nach 2 Wochen sitzt, Preply dazu. Bücher kommen von allein.

### Morgens (aufstehen bis DNB)
- Morgenbrief auf Kindle lesen
- Sonnengrüße (6x) + Liegestütze (30) + Plank (60s) — 10 Minuten
- GLOSS (Arabisch-Tage) oder Glossika (Persisch-Tage) — 20–30 Min.
...
|-----|-----------------|-------------------|-----------|
| Mo | GLOSS Levantine | — | McFit, ggf. Dresden |
| Di | Glossika Persisch | — | Laufen, Milan |
| Mi | Arabic Today + Ton | Arabisch (Libanesin) | McFit |
| Do | Glossika Persisch | Persisch (Afghanin) | Laufen |
| Fr | GLOSS Levantine | Arabisch (Libanesin) | McFit, Freunde abends |
...
| Was | Wann | Dauer |
|-----|------|-------|
| Camino | Mitte Juli – Anfang August | 3 Wochen |
| Tajikistan | September | 2–3 Wochen |
| Surfcamp Marokko (Taghazout) | Oktober | 2 Wochen |

Auf Reisen: Glossika offline auf dem Handy, 15 Min./Tag.

---

## 5. Einstieg (erste 2 Wochen)

Woche 1–2: Morgenbrief + Sport-Minimum + GLOSS/Glossika. Sonst nichts.
